...
setblock -30000000 0 1600 minecraft:test_block[mode=log]{mode:"log",message:"❌ [AME] Version conflict detected. Expected v2.0.0. Run /reload in-game for details."}
setblock -30000000 1 1600 minecraft:redstone_block

# ─── Broadcast warning ────────────────────────────────────
tellraw @a ["",{"text":"[AME] ","color":"#00AAAA","bold":true},{"text":"✘ ","color":"red"},{"text":"Version conflict! ","color":"red","bold":true},{"text":"Expected ","color":"dark_gray"},{"text":"v2.0.0","color":"aqua","bold":true},{"text":" — stored scores do not match.","color":"dark_gray"}]
