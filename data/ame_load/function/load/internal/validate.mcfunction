...
# ─── Global storage init ───────────────────────────────
execute unless data storage macro:engine global run data modify storage macro:engine global set value {version:"V1.0.5-PRE3"}
...
execute unless data storage macro:engine global{version:"V1.0.5-PRE3"} run data modify storage macro:names temp.vers set value "V1.0.5-PRE3"
execute unless data storage macro:engine global{version:"V1.0.5-PRE3"} run tellraw @a [{"text":"[AME] ","color":"aqua","bold":true},{"text":"Version mismatch — expected ","color":"red"},{"storage":"macro:names","nbt":"temp.vers","color":"yellow"},{"text":".","color":"red"}]
execute unless data storage macro:engine global{version:"V1.0.5-PRE3"} run return 0
