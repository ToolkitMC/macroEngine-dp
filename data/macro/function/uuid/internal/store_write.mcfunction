# ============================================================
# macro:uuid/internal/store_write  [MACRO FONKSİYON]
# UUID'yi macro:engine uuid_cache'e yazar (hem string hem array)
#
# Çağırma: function macro:uuid/internal/store_write with storage macro:input
# $(key)   = anahtar adı
# $(value) = UUID hex string (from_entity tarafından yazıldı)
# ============================================================
